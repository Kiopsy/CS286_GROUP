...
class GotoPoint():
    ...
    def get_position_cb(self, msg):
        ...
        r = euler_from_quaternion((msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w))

        self.curr_position.pose.pose.position.x = x
        self.curr_position.pose.pose.position.y = y
