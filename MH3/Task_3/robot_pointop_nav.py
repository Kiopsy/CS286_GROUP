...
class RobotSLAM_Nav:
    ...
    def odom_cb(self,msg):
        ...
        self.current_ori = (msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w)
    ...
    def move_along_direction(self):
        ...
        while not rospy.is_shutdown():    
            if(self.gotAOA):
                ...
                theta = self.move_direction / 180 * math.pi # convert radians,
                mag = self.step_size

                print(theta)

                delta_x = math.cos(theta) * mag
                delta_y = math.sin(theta) * mag
